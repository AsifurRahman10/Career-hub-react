...
export const JobDetails = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row w-11/12 md:w-9/12 mx-auto py-24 gap-6">
        ...
        <div className="bg-[#f4f1ff] p-8 rounded-lg space-y-4">
          ...
          <button className="w-full bg-hero-pattern text-xl font-extrabold py-3 text-white rounded-lg">
            Apply Now
          </button>
        </div>
      </div>
